    ...
    <section className="relative w-full min-h-screen flex items-center justify-center bg-black">
      <div className="absolute inset-0 overflow-hidden">
        <video  autoPlay playsInline loop muted className="absolute object-right inset-0 w-full h-full object-cover bg-right">
          <source src="https://res.cloudinary.com/drlyyxqh9/video/upload/v1719311430/Bawri%20Group/Landing%20Page/flight-of-gold-bokeh-sparkling-particles-with-alph-2023-11-27-05-17-42-utc_1_sd11qd.mp4" type="video/mp4" />
        </video>
      </div>
