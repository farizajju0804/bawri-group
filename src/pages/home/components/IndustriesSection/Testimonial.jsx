...
const Testimonial = () => {
    ...
    return (
        <section className="relative px-4 py-10 lg:py-20 mb-4 bg-white overflow-hidden">
            <div className="relative container px-4 mx-auto">
                <div className="w-full mx-auto">
                    <div className="flex flex-wrap -mx-4 items-center mb-8">
                        ...
                        <div className="w-full lg:w-1/3 px-4">
                            <div className="flex items-center justify-start lg:justify-end">
                                ...
                                <button onClick={() => setActiveSlide(activeSlide < slides.length - 1 ? activeSlide + 1 : slides.length - 1)} className="inline-flex w-14 h-14 items-center justify-center rounded-full bg-[#3b44f6] text-white transition duration-200">
                                    <svg width="12" height="14" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="flex items-center justify-center">
                        {slides.map((_, index) => (
                            <div key={index} onClick={() => { setActiveSlide(index); }} className={`${activeSlide === index ? 'bg-[#3b44cf]' : 'bg-gray-400 '} inline-block mr-1 w-7 h-1 cursor-pointer`}></div>
                        ))}
                    </div>
                </div>
            </div>
