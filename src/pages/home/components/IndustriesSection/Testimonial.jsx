                    ...
                    <div className="flex flex-wrap -mx-4 items-center mb-8">
                        ...
                        <div className="w-full lg:w-1/3 px-4">
                            <div className="flex items-center justify-start lg:justify-end">
                                <button onClick={() => setActiveSlide(activeSlide > 0 ? activeSlide - 1 : 0)} className="inline-flex mr-3 w-14 h-14 items-center justify-center rounded-full border border-gray-200 hover:border-[#3b44f6] text-gray-600 hover:text-[#3b44f6] transition duration-200">
